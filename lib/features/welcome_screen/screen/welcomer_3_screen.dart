...
class Welcomer3Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Image takes ~28% of screen height — responsive across all sizes
      ...
      body: SafeArea(
        child: Column(
          children: [
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        "دوای تەواوکردنی فێربوون و تاقیکردنەوەکان، ئێستا ئامادەیت بۆ هەنگاوی دوای. بە باوەڕ بە زانیاری و تواناکانت بچۆ بۆ تاقیکردنەوەی ڕاستەقینە و بێبەش مەبە لە وەرگرتنی مۆڵەتی شۆفێری. سەرکەوتن چاوەڕێت دەکات",
                        textAlign: TextAlign.right,
                        style: TextStyle(
                          fontFamily: 'Peshang',
            ...
            // ── Bottom navigator (always at bottom) ────────────────
            Spacer(flex: 3),
            Padding(
